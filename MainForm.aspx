        ...
        <div class="mail-box">
                  <aside class="sm-side">
                      <div class="user-head">
                          ...
                          <div class="user-name">
                              <h5><a href="#">Mumar Adam Villariasa</a></h5>
                              <span><a>IT / IT Leader</a></span>
                          </div>
                      ...
                      <ul class="inbox-nav inbox-divider">
                          <li class="active">
                              <a href="#"><i class="fa fa-inbox"></i> Logs <span class="label label-danger pull-right">2</span></a>

                          </li>
                          <li>
                              <a href="#"><i class="fa fa-envelope-o"></i> Sent Applications</a>
                          </li>
                          <li>
                              <a href="#"><i class="fa fa-bookmark-o"></i> Approved Leaves</a>
                          </li>
                          <li>
                              <a href="#"><i class=" fa fa-external-link"></i> Notifications <span class="label label-info pull-right">30</span></a>
                          </li>
                          <li>
                      ...
                      <ul class="nav nav-pills nav-stacked labels-info inbox-divider">
                          <li> <h4>Leave Credits</h4> </li>
                          <li> <a href="#"> <i class=" fa fa-sign-blank text-danger"></i> Vacation Leave </a> </li>
                          <li> <a href="#"> <i class=" fa fa-sign-blank text-success"></i> Sick Leave </a> </li>
                          <li> <a href="#"> <i class=" fa fa-sign-blank text-info "></i> Loyalty Leave </a>
                          </li>
                      </ul>
                      ...
                      <div class="inbox-head">
                          ...
                          <form action="#" class="pull-right position">
                              <div class="input-append">
                                  <input type="text" class="sr-input" placeholder="Search Application">
