<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostBack="true" CodeFile="Account.aspx.cs" Inherits="Account" %>
                         ...
                         <div class="row">
                             <div class="col-12" style="position: relative;width: 100%;min-height: 1px;padding-right: 15px;padding-left: 15px;flex: 0 0 100%;max-width: 100%; top: 20px;">
                                 ...
                                 <div class="tab-content" id="tablist">
                                             ...
                                             <div class="card-body">
                                                        ...
                                                        <div class="edit-basic-card" style="display:none;">
												            ...
												            <div class="row">
													            <div class="col-12 mt-3">
                                                                    <asp:Button class="btn btn-primary pmd-ripple-effect pmd-btn-raised" type="submit" ID="btnBISubmit" runat="server" Text="Submit" style="font-size:1.5rem;"/>
                                                 ...
                                                 <div class="details-tab">
											        <div class="d-flex flex-row align-items-center mb-2">
												        ...
												        <div class="dropdown pmd-dropdown pmd-user-info ml-auto" id="drpEdit" runat ="server">
													        <a href="#" class="pmd-btn-fab btn-outline-dark pmd-btn-flat btn btn-sm" data-toggle="dropdown" aria-expanded="true"><i class="material-icons pmd-icon-sm">more_vert</i></a>
													        <div class="dropdown-menu dropdown-menu-right" style="clip: rect(0px, 93.8594px, 0px, 93.8594px); transform: translate3d(-53.8594px, 0px, 0px);">
											        ...
											        <div class="edit-employee-card" style="display: none;">
												        ...
												        <div class="row">
													        <div class="col-12 mt-3">
														        <asp:Button class="btn btn-primary pmd-ripple-effect pmd-btn-raised" type="submit" ID="btnEISubmit" runat="server" Text="Submit" style="font-size:1.5rem;"/>
                                                        ...
                                                        <table class="table" id="maintable">  
                                                            ...
                                                            <tbody>  
                                                                <tr class="data-contact-person">  
                                                                    <td>  
                                                                        <asp:TextBox type="text" ID="empSchoolName" name="s-name" runat="server" class="form-control" style="font-size:1.6rem; line-height: 1;"></asp:TextBox></td>  
                                                                    <td>  
                                                                        <asp:TextBox type="text" ID="empSchoolCourse" name="c-name" runat="server" class="form-control" style="font-size:1.6rem; line-height: 1;"></asp:TextBox></td>  
                                                                    <td>  
                                                                        <asp:TextBox type="date" ID="empSchoolYAttend"  name="ya-date" runat="server" class="form-control" style="font-size:1.6rem; line-height: 1;"></asp:TextBox></td>  
                                                                    <td>  
                                                                        <asp:TextBox type="date" ID="empSchoolYGrad"  name="yg-date" runat="server" class="form-control" style="font-size:1.6rem; line-height: 1;"></asp:TextBox></td>
                                                                    <td>  
                                                                        <button type="button" id="btnAdd" class="btn btn-xs btn-primary classAdd" style="font-size:1.6rem; line-height: 1;">Add More</button>  
                                                                    </td>  
                                                                </tr>  
                                                            </tbody>  
                                                        </table>  
                                     ...
                                     <!--- Documents Tab-------->
                                     <div role="tabpanel" class="tab-pane fade show" id="documents">
                                         <div class="card pmd-card">
                                             <div class="card-body">
                                                 <div class="details-tab">
                                                     <div class="d-flex flex-row align-items-center mb-2">
        ...
        $(document).ready(function () {
            $(document).on("click", ".classAdd", function () { //
                ...
                var contactdiv = '<tr class="data-contact-person">' +
                    '<td><input type="text" name="s-name' + rowCount + '" class="form-control" style="font-size:1.6rem; line-height: 1;"/></td>' +
                    '<td><input type="text" name="c-name' + rowCount + '" class="form-control" style="font-size:1.6rem; line-height: 1;"/></td>' +
                    '<td><input type="date" name="ya-date' + rowCount + '" class="form-control" style="font-size:1.6rem; line-height: 1;"/></td>' +
                    '<td><input type="date" name="yg-date' + rowCount + '" class="form-control" style="font-size:1.6rem; line-height: 1;"/></td>' +
                    '<td><button type="button" id="btnAdd" class="btn btn-xs btn-primary classAdd" style="font-size:1.6rem; line-height: 1;">Add More</button>' +
                    '<button type="button" id="btnDelete" class="deleteContact btn btn btn-danger btn-xs" style="font-size:1.6rem; line-height: 1; margin-left: 5px;">Remove</button></td>' +
                    '</tr>';
